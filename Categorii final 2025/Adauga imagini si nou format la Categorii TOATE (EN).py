...
def process_html_file(file_path, base_url="https://neculaifantanaru.com/en"):
    """Procesează fișierul HTML pentru versiunea engleză"""
    ...
    try:
        ...
        for i, article in enumerate(articles):
            ...
            try:
                ...
                # URL complet - pentru versiunea engleză
                if url.startswith('/'):
                    full_url = "https://neculaifantanaru.com" + url
                ...
                if img_src and img_src.startswith('/'):
                    img_src = "https://neculaifantanaru.com" + img_src
                elif img_src and not img_src.startswith('http'):
                    img_src = "https://neculaifantanaru.com/" + img_src

                # Creează noul HTML - cu "about" în loc de "despre"
